    ...
    <nav class="navbar navbar-default navbar-static-top">
        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <h4 class="insurance" href="{{ url('/') }}"><i class="fab fa-drupal" style="font-size: 30px; color: crimson" ></i>ONLINE INSURANCE<i class="fab fa-drupal" style="font-size: 25px; color: white" ></i></h4>
