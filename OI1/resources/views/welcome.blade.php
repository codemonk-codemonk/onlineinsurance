...
<body>
      ...
      <div class="container">
        <nav style="position: fixed;z-index: 2">
            <h1 class="insurance"><i class="fab fa-drupal" style="font-size: 50px; color: crimson"></i> <a href="index.html">Ins<span>ura</span>nce</a></h1>
  ...
  <div class="dropdown-content">
    ...
    <a href="#"><i class="fas fa-home" style="font-size: 30px;color: crimson"></i>Home Insurance</a>
